...
Mupi-proxy (Multiple UPstream Interfaces multicast Proxy) is a proof of concept implementation of the extensions defined in IETF  [https://datatracker.ietf.org/doc/draft-asaeda-pim-multiif-igmpmldproxy/](draft-asaeda-pim-multiif-igmpmldproxy-04) to support multiple upstream interfaces in IGMP/MLD proxies. It has been implemented for Linux using an SDN application running over Ryu controller that controls and Open vSwitch in charge of relaying the multicast and IGMP/MLD traffic.
